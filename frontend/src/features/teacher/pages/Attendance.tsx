...
export default function Attendance() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-full">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">考勤管理</h1>
        <p className="text-gray-600">管理学生考勤记录，包括签到签退、请假管理和考勤统计。</p>
      </div>
      ...
      >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <Input placeholder="例如：08:00-09:40" />
            </Form.Item>
